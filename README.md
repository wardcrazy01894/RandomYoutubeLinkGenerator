...
- offers a **report** control on every draw — it always hides the video for you, and
  additionally files a report when a contact address is configured (`VITE_REPORT_EMAIL`)
