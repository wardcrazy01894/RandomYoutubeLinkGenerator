...
- offers a control on every draw that always hides the video for you, and additionally
  opens a prefilled report to send when a contact address is configured
  (`VITE_REPORT_EMAIL`)
